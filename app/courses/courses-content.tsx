...
import { CheckCircle, Download, BookOpen, Users, Award, Clock, MapPin } from "lucide-react"
      ...
      <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="py-10 md:py-20 bg-white">
        <div className="container mx-auto px-2 sm:px-4">
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.1 }} className="grid gap-8 lg:grid-cols-2 max-w-6xl mx-auto">
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="border-blue-200 hover:shadow-lg transition-shadow w-full max-w-full glass bg-white/80 border border-blue-200 text-blue-900" id="emotional-intelligence">
              <CardHeader>
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="border-blue-200 hover:shadow-lg transition-shadow w-full max-w-full glass bg-white/80 border border-blue-200 text-blue-900" id="train-the-trainer">
              <CardHeader>
                <div className="flex justify-between items-start mb-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100 mb-8" style={{ fontFamily: "Footlight MT Light, serif" }}>
              Contact us today to learn more about our training programs and schedule your session.
            </p>
